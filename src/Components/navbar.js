      ...
      <Navbar fixed="top" className="header-navbar" expand={"md"}>
        ...
        <div className="nav d-flex navlink">
          <Nav className="header-nav">
            <NavItem>
              <Nav.Link id="project-nav" className="project-nav" href="#projects" data-aos="fade-down" data-aos-delay="1850" data-aos-duration="1000"><h5>Projects</h5></Nav.Link>
            </NavItem>
            <NavItem>
            ...
            <NavItem>
              <Nav.Link id="about-nav" className="about-nav" href="#about-me" data-aos="fade-down" data-aos-delay="2350" data-aos-duration="1000"><h5>About</h5></Nav.Link>
            </NavItem>
          </Nav>
        </div>
      </Navbar>
