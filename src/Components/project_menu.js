    ...
    return(
      <div className="project-wrapper">
        ...
        <div className="jumbo-wrapper">
          ...
          <a href="https://icons8.com/">Envelope Icon provided by Icons8.com</a>
        </div>
      </div>
    )
  }
